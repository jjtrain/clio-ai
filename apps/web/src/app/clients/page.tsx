    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-1 text-sm">Manage your client relationships</p>
        </div>
      ...
      <div className="sm:hidden space-y-3">
        {isLoading ? (
          <div className="flex flex-col items-center py-12">
            ...
            <p className="text-gray-500 mt-3 text-sm">Loading clients...</p>
          </div>
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      <span className="text-xs text-gray-500">
                        {client._count.matters} matter{client._count.matters !== 1 ? 's' : ''}
                      </span>
                    </div>
                  </div>
                </div>
          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-gray-50/50">
                ...
                <TableHead className="font-semibold text-gray-600 hidden lg:table-cell">Added</TableHead>
                  ...
                  <TableRow key={client.id} className="hover:bg-gray-50/50">
                    ...
                    <TableCell>
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-gray-400 hidden md:inline">matters</span>
                      </div>
                    </TableCell>
                    <TableCell>
