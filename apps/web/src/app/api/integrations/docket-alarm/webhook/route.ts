...
import { processWebhook } from "@/lib/integrations/docket-alarm";
...
export async function POST(req: NextRequest) {
  try {
    ...
    // Find a matter linked to this case number
    ...
    console.error("[Docket Alarm Webhook] Error:", err.message);
